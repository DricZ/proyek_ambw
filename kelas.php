                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr class="hoverablerow">
                            <form>
                                <td><?php echo $row['name'] ?><input type="hidden" name="name"
                                        value="<?php echo $row['name'] ?>"></td>
                                <td><?php echo $row['status'] ?><input type="hidden" name="status"
                                        value="<?php echo $row['status'] ?>"></td>
                                <td><?php echo $row['tanggal_buka'] ?><input type="hidden" name="tanggal_buka"
                                        value="<?php echo $row['tanggal_buka'] ?>"></td>
                                <td><?php echo $row['tanggal_berakhir'] ?><input type="hidden" name="tanggal_berakhir"
                                        value="<?php echo $row['tanggal_berakhir'] ?>"></td>
                                <td><?php echo $row['harga'] ?><input type="hidden" name="harga"
                                        value="<?php echo $row['harga'] ?>"></td>
                                <td><?php echo $row['kelas'] ?><input type="hidden" name="kelas"
                                        value="<?php echo $row['kelas'] ?>"></td>
                                <td><?php echo $row['kuota'] ?><input type="hidden" name="kuota"
                                        value="<?php echo $row['kuota'] ?>"></td>
                                <td><?php echo $result2[0]['total_siswa'] ?><input type="hidden" name="total_siswa"
                                        value="<?php echo $result2[0]['total_siswa'] ?>"></td>

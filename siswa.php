                    ...
                    <table id="example" class="table">
                        ...
                        ?>
                            <tr class="hoverablerow">
                                <form>
                                    <td><?php echo $row['full_name'] ?><input type="hidden" name="full_name"
                                            value="<?php echo $row['full_name'] ?>"></td>
                                    <td><?php echo $row['status'] ?><input type="hidden" name="status"
                                            value="<?php echo $row['status'] ?>"></td>
                                    <td><?php echo $row['tanggal_pendaftaran'] ?><input type="hidden"
                                            name="tanggal_pendaftaran"
                                            value="<?php echo $row['tanggal_pendaftaran'] ?>">
                                    </td>
                                    <td><?php echo $row['no_wa'] ?><input type="hidden" name="no_wa"
                                            value="<?php echo $row['no_wa'] ?>"></td>
                                    <td><?php echo $row['nama_kelas'] ?><input type="hidden" name="nama_kelas"
                                            value="<?php echo $row['nama_kelas'] ?>"></td>
